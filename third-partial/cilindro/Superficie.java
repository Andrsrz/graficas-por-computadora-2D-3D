...
public class Superficie extends JFrame implements KeyListener {
	...
	public void makeCube(){
		...
		for (int i = 0 ; i<enmayado ; i++) {
			//trasladaorigen();
			int sx = x+((int)((1*cosenoy)+(1*senoy))*(int)((1*cosenoz)-(1*senoz)));
			int sy = y+((int)((1*cosenox)-(1*senox))*(int)((1*cosenoz)+(1*senoz)));
			int sz = z+((int)((1*senox)+(1*cosenox))*(int)((1*cosenoy)+(1*senoy)));
